...
<head>
    ...
    <title>Take and Gift | Detail Produk</title>
            ...
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-2 col-6 footer-links">
                        <h4>Tautan</h4>
                        <ul>
                            <li><i class="bi bi-chevron-right"></i> <a href="halaman-user.php">Beranda</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="halaman-user.php">Tentang Kami</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="halaman-user.php">Kategori</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="halaman-user.php">Produk Kami</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="halaman-user.php">Hubungi Kami</a></li>
                        </ul>
                    </div>
