...
$conn = mysqli_connect("localhost", "root", "", "takeandgift");
// End
...
// Fungsi tampilkan kategori hampers
function kategori_hampers()
{
	global $conn;

	$result_kategori_hampers = $conn->query("SELECT * FROM tbl_produk WHERE kategori = 'Hampers' ORDER BY id_produk DESC");
	$rows_produk = [];
	while ($row_produk = mysqli_fetch_assoc($result_kategori_hampers)) {
		$rows_produk[] = $row_produk;
	}
	return $rows_produk;
}
...
// Fungsi tampilkan kategori buket
function kategori_bouquet()
{
	global $conn;

	$result_kategori_bouquet = $conn->query("SELECT * FROM tbl_produk WHERE kategori = 'Buket' ORDER BY id_produk DESC");
	$rows_produk = [];
	while ($row_produk = mysqli_fetch_assoc($result_kategori_bouquet)) {
		$rows_produk[] = $row_produk;
	}
	return $rows_produk;
}
...
// Tampil Kategori Hampers
$sql_kategori_hampers = $conn->query("SELECT * FROM tbl_produk WHERE kategori = 'Hampers'");
$jml_kategori_hampers = mysqli_num_rows($sql_kategori_hampers);


// Tampil Kategori buket
$sql_kategori_buket = $conn->query("SELECT * FROM tbl_produk WHERE kategori = 'Buket'");
$jml_kategori_buket = mysqli_num_rows($sql_kategori_buket);
// End
