...
<head>
    ...
    <title>Take and Gift | Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion pt-3" id="accordionSidebar" style="background-color: #0245bc;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-1">Take and Gift</div>
            </a>
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto ml-3">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        <?= number_format($jml_kategori_hampers); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto mr-3">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ml-3">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Kategori Buket</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?= number_format($jml_kategori_buket); ?>
                                            </div>
                                        </div>
                                        <div class="col-auto mr-3">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Take and Gift 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
